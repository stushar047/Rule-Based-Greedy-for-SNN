...
keras_loss_train, keras_acc_train, keras_loss_test, keras_acc_test, keras_weights = get_GD_based_synaptic_weights(X_train,y_train,activation='softmax',lr=lr,b1=b1,b2=b2,epochs=epochs, batch_size=batch_size, verbose=0,seed=seed,shuffle=False)
...
file=open("result_data.csv","a")

file.write(f"{f_sample},{abs_period_},{epochs},{abs_epoch},{method},{app},{keras_acc_train},{keras_acc_test},{acctrain},{acctest},{absperiod},{keras_weights}\n")
